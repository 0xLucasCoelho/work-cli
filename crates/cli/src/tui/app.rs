...
impl App {
    ...
    pub(crate) fn request_confirm(&mut self, c: Confirm) {
        self.confirm = Some(c);
    }
    ...
    pub(crate) fn request_attach(&mut self, name: String) {
        self.pending = Some(PendingAction::Attach(name));
    }
    ...
    pub(crate) fn enter_mode(&mut self, m: Mode) {
        self.mode = Some(m);
        self.buf.clear();
    }
    pub(crate) fn cancel_mode(&mut self) {
        self.mode = None;
        self.buf.clear();
    }
    pub(crate) fn buf_push(&mut self, c: char) {
        self.buf.push(c);
    }
    pub(crate) fn buf_pop(&mut self) {
        self.buf.pop();
    }
    pub(crate) fn buf_str(&self) -> &str {
        &self.buf
    }
